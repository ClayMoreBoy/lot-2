...
<template>
  <div class="kl8-wrapper xin-wrapper">
    ...
    <div class="content">
      ...
      <div class="bet-top">
          <div class="qishu">
            <span class="l-name">北京快乐8 </span>第<span class="l-qs"> 179984 </span>期<router-link class="icon-ques1" to="/"></router-link>
          ...
          <div class="betnum">
            <p><span>02</span><span>12</span><span>36</span><span>36</span><span>36</span><span>36</span><span>36</span><span>36</span><span>36</span><span>36</span><span>36</span> </p>
            <p><span>02</span><span>12</span><span>36</span><span>36</span><span>36</span><span>36</span><span>36</span><span>36</span><span>36</span><span>36</span><span>36</span></p>
          </div>
      </div>
      <!--开奖记录-->
      ...
      <div class="xin-bet-box" :class="{ 'beShort' : showBetbox }">
        ...
        <div class="leftBox wrapper" ref="leftWrapper">
          <div class="content">
            <tab>
              <tab-item selected ><i></i>选五</tab-item>
              <tab-item ><i></i>选四</tab-item>
              <tab-item ><i></i>选三</tab-item>
            </tab>
          </div>
        </div>
        <div class="rightBox " ref="rightWrapper">
          <div class="content">
            <div class="cont-1" >
              <div class="dingwei">选三<i class="icon-bet-help" @click="betHelpDialogHandler"></i></div>
              <!--彩票内容区域：-->
              <div class="pour-box">
