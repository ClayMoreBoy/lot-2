  ...
  <div>
    ...
    <div class="wrapper content-wrapper" ref="wrapper">
      <div class="content">
        ...
        <div class="bet-top">
          <div class="left-p">
            <div class="qishu"><span class="l-name">新疆时时彩</span>第<span class="l-qs">20179984</span>期<router-link class="icon-ques1" to="/"></router-link></div>
    ...
    <div class="lottery-bet1-footer">
      ...
      <div class="btn-bet disabled" @click="betDialog">投注</div> <!--开启状态去除disabled样式-->
    ...
    <!--投注弹窗-->
    <my-dialog :isShow="betDialogShow" @on-result-change="onResultChange3"  @dialogHandler="betDialog">
